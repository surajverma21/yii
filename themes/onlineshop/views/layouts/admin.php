...
<div class="main_content">
			...
			?>
                    ...
                    <!--[if lte IE 6]><table><tr><td><![endif]-->
                        <ul>
                        <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/admin/addslide">Slider Settings</a></li>
                        <li><a href="" title="">Products</a></li>
                        <li><a href="" title="">User Permissions</a></li>
                        <li><a class="sub1" href="" title="">sublevel2<!--[if IE 7]><!--></a><!--<![endif]-->
                        <!--[if lte IE 6]><table><tr><td><![endif]-->
                            <ul>
                                <li><a href="" title="">sublevel link</a></li>
                    ...
                    <li><a class="" href="">Templates & Images</a></li>
