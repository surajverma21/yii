...
<div id="main_container">
    ...
    <div class="logo"><a href="#"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/logo.gif" alt="" title="" border="0" /></a></div>
    ...
    <div class="footer_login">
    	...
    	<div class="right_footer_login"><a href="http://indeziner.com"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/indeziner_logo.gif" alt="" title="" border="0" /></a></div>
